...
Welcome to Part 2 of the Genesis Event for Dymension Hub's 35-C testnet. We recommend reviewing `What is a Genesis File?` [here](https://github.com/cosmos/gaia/blob/main/docs/resources/genesis.md). Below you will find the source of the genesis file which includes validator Gentxs provided in Part 1. Follow these instructions to download the genesis file, validate, and prepare for launching the testnet!

**Genesis File**

```sh
curl TODO > ~/.dymension/config/genesis.json
```
...
TODO ~/.dymension/config/genesis.json
```
